...
library(MASS)
# Generate 1000 standard normal random deviates, and assign them to variable “x”
x = rnorm(1000)	
# Do the same for “y”
y = rnorm(1000)
...
```r
tapply(incomes, country.factors, mean)
```



```
## Error: object 'country.factors' not found
```
...
##  -0.894   1.640   3.100   3.020   4.100   7.650 
```

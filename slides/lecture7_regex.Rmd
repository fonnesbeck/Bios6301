...
## Substituting with Placeholders

The replacement argument can utilize placeholders, such as \\1 or \\2 for as many placeholders are created in the pattern.  To create a placeholder, surround a section of the pattern with parantheses.

```{r}
gsub("(time).*", "\\1 flies", "time to go")
```
